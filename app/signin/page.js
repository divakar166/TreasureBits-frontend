        ...
        <div className="p-5">
          ...
          <form method="POST">
            <div className="flex flex-col">
              ...
              <input type="text" placeholder="Enter your mail address" className="py-2 px-3 text-sm border-gray-300 border-2 rounded-lg" required />
            </div>
            <div className="flex flex-col">
              <label className="text-black leading-8">Password <span className="text-red-600">*</span></label>
              <input type="password" placeholder="Enter password" className="py-2 px-3 text-sm border-gray-300 border-2 rounded-lg" required />
            </div>
